...
* Chroma and Timbre self-similarity matrices for the song i most frequently listened to.
...
* As you can see the key frequency over the whole playlist is distributed fairly even, however C# and G seem to be the most common with over a hundred songs each and D# the least with only 22 songs. So i conclude that either i really like C# and G and dislike D# or these are just very popular/unpopular keys in music. 
...
### Valence VS Energy (Yearly) 2017-2020
